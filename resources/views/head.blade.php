<head>
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function () {
            var menuItems = document.querySelectorAll('.menu-item.sub-menu');
    ...
    <link rel="stylesheet" href="{{ asset('css/app_s.css') }}" type="text/css">
    ...
    <title>JURSE 2024 - Événement de Télédétection Urbaine Conjointe</title>
